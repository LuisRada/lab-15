...
int main() {
    ...
    AutoFactory<Mage> mageFactory;
    AutoFactory<Warrior> warriorFactory;

    auto mage = mageFactory.create("Gandalf", {10, 8, 5, 2, 9});
    auto warrior = warriorFactory.create("Conan", {9, 10, 7, 3, 6});

    std::cout << mage->getType() << " created: " << mage->getName() << "\n";
    std::cout << warrior->getType() << " created: " << warrior->getName() << "\n";
