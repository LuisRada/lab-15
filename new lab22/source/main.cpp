...
int main() {
    ...
    Character* mage = new Mage("elmago", std::vector<int>{80,10,30,20,100});
    Character* warrior = new Warrior("elguerrero", std::vector<int>{80,10,30,20,100});
